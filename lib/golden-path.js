...
const GOLDEN_TOPIC = "GLP-1 receptor";
...
const GOLDEN_PROTEIN = {
  ...
  alphafoldPdbUrl:
    "https://alphafold.ebi.ac.uk/files/AF-P43220-F1-model_v6.pdb",
};

const GOLDEN_NOTES_EXAMPLE = `GLP-1 is a hormone that lowers blood sugar. Semaglutide is a GLP-1 drug used for diabetes. I think the receptor was found in the 2000s when these drugs were invented.`;

const GOLDEN_DEMO_QUESTION =
...
const GOLDEN_MILESTONES = [
  ...
  },
  {
    ...
    sourceUrl:
      "https://www.accessdata.fda.gov/drugsatfda_docs/nda/2005/021773_Byetta_toc.cfm",
  },
  {
    id: "AMDC_liraglutide",
    kind: "drug",
    ...
    sourceUrl:
      "https://www.ebi.ac.uk/chembl/compound_report_card/CHEMBL1201511/",
  ...
  },
  {
    ...
    sourceUrl:
      "https://www.ebi.ac.uk/chembl/compound_report_card/CHEMBL3707340/",
    extra: "maxClinicalStage APPROVAL",
  },
  {
    id: "AMTC_step1",
...
// Citation story: later literature cites earlier papers; the cloned gene
// links back to those papers; trials cite the drugs/papers they study;
// regulatory authorizations cite the trials that justified the label.
const GOLDEN_EDGES = [
  { from: "AMBC_glp1_1987", to: "AMBC_glp1_1983", label: "cites", arrows: "to" },
  { from: "AMGC_glp1r_cloned", to: "AMBC_glp1_1983", label: "builds on", arrows: "to" },
  { from: "AMGC_glp1r_cloned", to: "AMBC_glp1_1987", label: "builds on", arrows: "to" },
  { from: "AMBC_exendin_1992", to: "AMBC_glp1_1987", label: "cites", arrows: "to" },
  { from: "AMBC_exendin_1992", to: "AMGC_glp1r_cloned", label: "targets", arrows: "to" },
  { from: "AMRC_exenatide_2005", to: "AMBC_exendin_1992", label: "based on", arrows: "to" },
  { from: "AMRC_exenatide_2005", to: "AMGC_glp1r_cloned", label: "targets", arrows: "to" },
  { from: "AMDC_liraglutide", to: "AMGC_glp1r_cloned", label: "targets", arrows: "to" },
  { from: "AMDC_liraglutide", to: "AMRC_exenatide_2005", label: "follows", arrows: "to" },
  { from: "AMTC_sustain6", to: "AMDC_semaglutide", label: "studies", arrows: "to" },
  { from: "AMTC_sustain6", to: "AMGC_glp1r_cloned", label: "targets", arrows: "to" },
  { from: "AMDC_semaglutide", to: "AMDC_liraglutide", label: "follows", arrows: "to" },
  { from: "AMDC_semaglutide", to: "AMGC_glp1r_cloned", label: "targets", arrows: "to" },
  { from: "AMTC_step1", to: "AMDC_semaglutide", label: "studies", arrows: "to" },
  { from: "AMTC_step1", to: "AMTC_sustain6", label: "builds on", arrows: "to" },
  { from: "AMRC_wegovy_2021", to: "AMTC_step1", label: "based on", arrows: "to" },
  { from: "AMRC_wegovy_2021", to: "AMDC_semaglutide", label: "authorizes", arrows: "to" },
  { from: "AMTC_select", to: "AMTC_step1", label: "builds on", arrows: "to" },
  { from: "AMTC_select", to: "AMDC_semaglutide", label: "studies", arrows: "to" },
];

const GOLDEN_GRAPH = {
  nodes: GOLDEN_MILESTONES.map(graphNode),
  edges: GOLDEN_EDGES,
};
